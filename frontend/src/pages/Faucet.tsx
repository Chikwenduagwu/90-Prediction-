...
import { USDC_ABI } from "@/lib/contractAbi";
    ...
    <main style={{ maxWidth: "520px", margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "0.875rem", color: "var(--text-secondary)", maxWidth: "340px", margin: "0 auto 1.75rem" }}>
          Claim free test USDC to try out prediction markets on XLayer Testnet. No real money involved.
        </p>
        ...
        {!isConnected ? (
          ...
          >
            {isPending ? "Confirm in wallet…" : isConfirming ? "Processing…" : `🚰 Claim ${FAUCET_AMOUNT}`}
          </button>
        )}
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        {[
          { icon: "🔗", title: "Testnet Only", desc: "This faucet works on XLayer Testnet. No real funds are involved." },
